...
/**
 * Busca o UID do usuário APENAS pelo e-mail.
 * @param {string} email
 * @returns {string} userId
 */
async function getUserId(email) { // REMOVIDO 'telefone' do parâmetro
...
        
        // ---------------------------------------------------------------------------------------------------
        // O restante do código de parcelamento
        // ---------------------------------------------------------------------------------------------------
...
                
                // Utiliza os dados reais do cartão
...
        const userId = await getUserId(email, telefone); // CHAMADA INCORRETA
